...
if (!defined('CIVICRM_UF_DSN') && CIVICRM_UF !== 'UnitTests') {
  define( 'CIVICRM_UF_DSN'           , 'mysql://compucorp:compucorp@2016@localhost/drupal_civicrm?new_link=true');
}
...
if (!defined('CIVICRM_DSN')) {
  if (CIVICRM_UF === 'UnitTests' && isset($GLOBALS['_CV']['TEST_DB_DSN'])) {
    ...
    define('CIVICRM_DSN', 'mysql://compucorp:compucorp@2016@localhost/drupal_civicrm?new_link=true');
  }
}
...
$civicrm_root = '/home/webapps/patilstar/sub_domain/testpad/compucorp/sites/all/modules/civicrm';
if (!defined('CIVICRM_TEMPLATE_COMPILEDIR')) {
  define( 'CIVICRM_TEMPLATE_COMPILEDIR', '/home/webapps/patilstar/sub_domain/testpad/compucorp/sites/default/files/civicrm/templates_c/');
}
...
if (!defined('CIVICRM_UF_BASEURL')) {
  define( 'CIVICRM_UF_BASEURL'      , 'http://testpad.patilstar.com/compucorp/');
}
...
if (!defined('CIVICRM_SITE_KEY')) {
  define( 'CIVICRM_SITE_KEY', '54c6ead708879b1fb27da29ef990deee');
}
...
// define( 'CIVICRM_MAIL_LOG', '/home/webapps/patilstar/sub_domain/testpad/compucorp/sites/default/files/civicrm/templates_c//mail.log');
// }
